/********************************************************************************************
* Abstract: run tests against known answer test vectors for SIKEp434_compressed
*
...
main()
{
    ...
    unsigned char       ct[CRYPTO_CIPHERTEXTBYTES] = {0}, ss[CRYPTO_BYTES], ss1[CRYPTO_BYTES], ct_rsp[CRYPTO_CIPHERTEXTBYTES], ss_rsp[CRYPTO_BYTES];
    int                 count;
    int                 done;
    ...
    do {
        ...
        if ( (ret_val = crypto_kem_keypair_SIKEp434_compressed_speed(pk, sk)) != 0) {
        ...
        if ( (ret_val = crypto_kem_enc_SIKEp434_compressed_speed(ct, ss, pk)) != 0) {
        ...
        if ( (ret_val = crypto_kem_dec_SIKEp434_compressed_speed(ss1, ct, sk)) != 0) {

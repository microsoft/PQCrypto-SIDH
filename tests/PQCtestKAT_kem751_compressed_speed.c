/********************************************************************************************
* Abstract: run tests against known answer test vectors for SIKEp751_compressed_speed
*
...
main()
{
    ...
    do {
        ...
        if ( (ret_val = crypto_kem_keypair_SIKEp751_compressed_speed(pk, sk)) != 0) {
        ...
        if ( (ret_val = crypto_kem_enc_SIKEp751_compressed_speed(ct, ss, pk)) != 0) {
        ...
        if ( (ret_val = crypto_kem_dec_SIKEp751_compressed_speed(ss1, ct, sk)) != 0) {

...
#define CRYPTO_SECRETKEYBYTES     240      // MSG_BYTES + SECRETKEY_A_BYTES + CRYPTO_PUBLICKEYBYTES bytes
...
// Outputs: secret key sk (CRYPTO_SECRETKEYBYTES = 240 bytes)
...
// private keys are encoded in 240 octets in little endian format. 

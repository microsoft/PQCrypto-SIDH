...
*
* Abstract: API header file for P434 using compression with ciphertext vs decaps. speed tradeoff
*********************************************************************************************/  

#ifndef P434_COMPRESSED_SPEED_API_H
#define P434_COMPRESSED_SPEED_API_H
...
// Algorithm name
#define CRYPTO_ALGNAME "SIKEp434_compressed_speed"  

// SIKE's key generation
// It produces a private key sk and computes the public key pk.
// Outputs: secret key sk (CRYPTO_SECRETKEYBYTES = 350 bytes)
//          public key pk (CRYPTO_PUBLICKEYBYTES = 197 bytes) 
int crypto_kem_keypair_SIKEp434_compressed_speed(unsigned char *pk, unsigned char *sk);
...
int crypto_kem_enc_SIKEp434_compressed_speed(unsigned char *ct, unsigned char *ss, const unsigned char *pk);

// SIKE's decapsulation
// Input:   secret key sk         (CRYPTO_SECRETKEYBYTES = 350 bytes)
//          ciphertext message ct (CRYPTO_CIPHERTEXTBYTES = 236 bytes) 
// Outputs: shared secret ss      (CRYPTO_BYTES = 16 bytes)
int crypto_kem_dec_SIKEp434_compressed_speed(unsigned char *ss, const unsigned char *ct, const unsigned char *sk);



// Encoding of keys for KEM-based isogeny system "SIKEp434_compressed_speed" (wire format):
// ---------------------------------------------------------------------------------
...
int EphemeralKeyGeneration_A_SIDHp434_Compressed_Speed(unsigned char* PrivateKeyA, unsigned char* PublicKeyA);
...
int EphemeralKeyGeneration_B_SIDHp434_Compressed_Speed(const unsigned char* PrivateKeyB, unsigned char* PublicKeyB);
...
int EphemeralSecretAgreement_A_SIDHp434_Compressed_Speed(const unsigned char* PrivateKeyA, const unsigned char* PublicKeyB, unsigned char* SharedSecretA, unsigned char* phiBKA_t);
...
int EphemeralSecretAgreement_B_SIDHp434_Compressed_Speed(const unsigned char* PrivateKeyB, const unsigned char* PublicKeyA, unsigned char* SharedSecretB);

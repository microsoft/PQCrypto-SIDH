...
*
* Abstract: supersingular isogeny parameters and generation of functions for P610_compressed_speed
*********************************************************************************************/

#include "P610_compressed_speed_api.h"
#define COMPRESS
...
const unsigned int ph2_path[PLEN_2] = { // w_2 = 5
...
#if W_3 == 4
0, 0, 1, 2, 3, 4, 4, 5, 5, 6, 7, 7, 8, 9, 10, 10, 11, 12, 13, 14, 14, 14, 15, 16, 17, 18, 19, 19, 19, 19, 20, 21, 22, 23, 24, 25, 26, 26, 26, 26, 26, 27, 28, 29, 30, 31, 32, 33, 34  
#elif W_3 == 6  
...
#include "../compression/sidh_compressed_speed.c"
#include "../compression/sike_compressed_speed.c"

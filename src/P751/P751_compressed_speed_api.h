...
*
* Abstract: API header file for P751 using compression with ciphertext vs decaps. speed tradeoff
*********************************************************************************************/  

#ifndef P751_COMPRESSED_SPEED_API_H
#define P751_COMPRESSED_SPEED_API_H
...
#define CRYPTO_CIPHERTEXTBYTES    410      // COMPRESSED_CHUNK_CT + MSG_BYTES bytes     

// Algorithm name
#define CRYPTO_ALGNAME "SIKEp751_compressed_speed" 

// SIKE's key generation
// It produces a private key sk and computes the public key pk.
// Outputs: secret key sk (CRYPTO_SECRETKEYBYTES = 414 bytes)
//          public key pk (CRYPTO_PUBLICKEYBYTES = 335 bytes) 
int crypto_kem_keypair_SIKEp751_compressed_speed(unsigned char *pk, unsigned char *sk);
...
int crypto_kem_enc_SIKEp751_compressed_speed(unsigned char *ct, unsigned char *ss, const unsigned char *pk);

// SIKE's decapsulation
// Input:   secret key sk         (CRYPTO_SECRETKEYBYTES = 414 bytes)
//          ciphertext message ct (CRYPTO_CIPHERTEXTBYTES = 410 bytes) 
// Outputs: shared secret ss      (CRYPTO_BYTES = 32 bytes)
int crypto_kem_dec_SIKEp751_compressed_speed(unsigned char *ss, const unsigned char *ct, const unsigned char *sk);
...
// ct is encoded in 3*47 + 188 + 2 + 32 = 410 octets.  
...
int EphemeralKeyGeneration_A_SIDHp751_Compressed_Speed(unsigned char* PrivateKeyA, unsigned char* PublicKeyA);
...
int EphemeralKeyGeneration_B_SIDHp751_Compressed_Speed(const unsigned char* PrivateKeyB, unsigned char* PublicKeyB);
...
int EphemeralSecretAgreement_A_SIDHp751_Compressed_Speed(const unsigned char* PrivateKeyA, const unsigned char* PublicKeyB, unsigned char* SharedSecretA, unsigned char* phiBKA_t);
...
int EphemeralSecretAgreement_B_SIDHp751_Compressed_Speed(const unsigned char* PrivateKeyB, const unsigned char* PublicKeyA, unsigned char* SharedSecretB);
